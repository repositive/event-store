...
*/
export declare function createEvent<T extends EventData>(event_namespace: T["event_namespace"], event_type: T["event_type"], data: Omit<T, "event_namespace" | "event_type" | "type">, context?: EventContext<any>, _uuid?: () => Uuid): Event<T, EventContext<any>>;
/**
...
```
*/
export declare function createContext(subject: object, action?: string, _time?: () => IsoDateString): EventContext<any>;
/**
